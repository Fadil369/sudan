...
const SocialWelfareMinistryPortal = ({ language = 'en' }) => {
  ...
  const t = {
    en: {
      ...
      serviceItems: [
        { id: 'cash_transfer', icon: <AttachMoney />, label: 'Cash Transfer (Tawakkalna)', desc: 'Apply for government cash transfer assistance for vulnerable families', color: '#10b981' },
        { id: 'disability', icon: <Accessibility />, label: 'Disability Support', desc: 'Register for disability benefits and specialized services', color: '#0ea5e9' },
        { id: 'orphan', icon: <ChildCare />, label: 'Orphan Care Program', desc: 'Enroll orphaned children in the national care program', color: '#f59e0b' },
        { id: 'elderly', icon: <ElderlyWoman />, label: 'Elderly Pension', desc: 'Apply for elderly social pension (age 60+)', color: '#6366f1' },
        { id: 'housing', icon: <Home />, label: 'Social Housing', desc: 'Apply for affordable social housing units', color: '#ec4899' },
        { id: 'women', icon: <Favorite />, label: 'Women Empowerment', desc: 'Access programs for women entrepreneurship and legal support', color: '#a855f7' },
        { id: 'food', icon: <People />, label: 'Food Security Subsidy', desc: 'Register for subsidized food assistance programs', color: '#22c55e' },
        { id: 'microfinance', icon: <AttachMoney />, label: 'Zakat & Microfinance', desc: 'Apply for Zakat support or microfinance loans', color: '#ef4444' },
      ],
    ...
    ar: {
      ...
      serviceItems: [
        { id: 'cash_transfer', icon: <AttachMoney />, label: 'برنامج التحويلات النقدية (توكلنا)', desc: 'التقدم للمساعدة النقدية الحكومية للأسر المستضعفة', color: '#10b981' },
        { id: 'disability', icon: <Accessibility />, label: 'دعم ذوي الإعاقة', desc: 'التسجيل للحصول على مزايا ذوي الإعاقة والخدمات المتخصصة', color: '#0ea5e9' },
        { id: 'orphan', icon: <ChildCare />, label: 'برنامج رعاية الأيتام', desc: 'تسجيل الأطفال الأيتام في البرنامج الوطني للرعاية', color: '#f59e0b' },
        { id: 'elderly', icon: <ElderlyWoman />, label: 'معاش كبار السن', desc: 'التقدم للمعاش الاجتماعي لكبار السن (60 عاماً فأكثر)', color: '#6366f1' },
        { id: 'housing', icon: <Home />, label: 'الإسكان الاجتماعي', desc: 'التقدم لوحدات سكنية ميسورة التكلفة', color: '#ec4899' },
        { id: 'women', icon: <Favorite />, label: 'تمكين المرأة', desc: 'الوصول إلى برامج ريادة الأعمال والدعم القانوني للمرأة', color: '#a855f7' },
        { id: 'food', icon: <People />, label: 'دعم الأمن الغذائي', desc: 'التسجيل في برامج دعم الغذاء المدعوم', color: '#22c55e' },
        { id: 'microfinance', icon: <AttachMoney />, label: 'الزكاة والتمويل الأصغر', desc: 'التقدم لدعم الزكاة أو قروض التمويل الأصغر', color: '#ef4444' },
      ],
  ...
  const stats = [
    { label: txt.beneficiaries, value: '5.06M', color: '#10b981', progress: 75 },
    { label: txt.programs, value: '7', color: '#0ea5e9', progress: 90 },
    { label: txt.budget, value: '53B SDG', color: '#f59e0b', progress: 82 },
    { label: txt.centers, value: '420', color: '#a855f7', progress: 68 },
  ];
