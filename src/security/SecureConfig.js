...
class SecureConfig {
  ...
  loadEnvironmentConfig() {
    ...
    // API Configuration
    this.set('api.baseUrl', process.env.REACT_APP_API_BASE_URL || 'http://localhost:8080/api');
    ...
    this.set('brainsait.sudanOidBranch', process.env.REACT_APP_SUDAN_OID_BRANCH || '1.3.6.1.4.1.61026.1');
  ...
  buildCSPHeader() {
    const baseCSP = [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' https://cdn.sudan.gov.sd",
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
      "font-src 'self' https://fonts.gstatic.com",
      "img-src 'self' data: https:",
      "connect-src 'self' https://api.sudan.gov.sd https://api.brainsait.com",
